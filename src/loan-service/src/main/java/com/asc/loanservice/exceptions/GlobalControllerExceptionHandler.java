...
import com.asc.loanservice.contracts.ErrorResponse;
...
class GlobalControllerExceptionHandler {
  ...
  public ResponseEntity<?> handleExpiredJwtException(LoanNotFoundException ex, WebRequest request) {
    return new ResponseEntity<>(new ErrorResponse("loan not found"), HttpStatus.NOT_FOUND);
  }
}
